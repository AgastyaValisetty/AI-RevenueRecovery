  ...
  return (
    ...
    >
      <div className="relative flex h-full w-full flex-col rounded-none md:rounded-2xl bg-background text-foreground antialiased transition-colors duration-200">
        ...
        {/* 2. Desktop Right Action Notch (Reset DB) */}
        <aside
          ...
          className={cn(
            ...
            isBottom
              ? "bottom-0 rounded-tl-[24px]"
              : "top-0 rounded-bl-[24px]"
          )}
        >
          <NotchLeftWing position={position} />
          ...
          <button
            ...
            className="flex cursor-pointer items-center gap-1.5 rounded-full px-3.5 py-2 text-xs font-semibold text-zinc-400 hover:text-zinc-200 dark:text-zinc-600 dark:hover:text-zinc-900 outline-none transition-colors focus-visible:ring-2 focus-visible:ring-zinc-400 dark:focus-visible:ring-zinc-500"
          >
        ...
        >
          ...
          >
            ...
            {/* Reset DB Button (mobile) */}
            <button
              type="button"
              onClick={onResetDb}
              aria-label="Reset database"
              className="flex shrink-0 items-center justify-end text-zinc-50 dark:text-zinc-950"
            >
              <Database className="size-4 sm:size-4 shrink-0 text-zinc-400 dark:text-zinc-600 hover:text-zinc-200 dark:hover:text-zinc-900" />
            </button>
          </div>
